...
const LandingPage = () => {
  const fetchData = async () => {
    const res = await trpc.getShelters();
                    ...
                    <div className="flex flex-col items-center space-y-4 text-center">
                      <div className="space-y-2">
                        ...
                        <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                          Efficiently manage and distribute food resources
                          across multiple animal shelters with our intuitive
                          CMS.
                        </p>
                      </div>
                    ...
                    <div className="grid gap-10 px-10 md:gap-16 lg:grid-cols-2">
                      <div className="space-y-4">
                        ...
                        <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                          Our CMS has helped hundreds of animal shelters
                          optimize their food distribution, resulting in better
                          care for animals and reduced waste.
                        </p>
                      </div>
                    ...
                    <div className="flex flex-col items-center space-y-4 text-center">
                      <div className="space-y-2">
                        ...
                        <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                          Get in touch with us to learn how ShelterShare CMS can
                          help your animal shelter.
                        </p>
                      </div>
